...
firepad.ParseHtml = (function () {
  ...
  ParseOutput.prototype.skipEmptyLines = function() {//it removes empty lines from MS Word markup
    var i = 0;
      ...
      var val = firepad.utils.trim(stylePieces[1]).toLowerCase();
        switch (prop) {
            case 'text-decoration':
                break;//remove a text formating wich is not customizing due to PRDEV-1334
            ...
            case 'text-align':
                ...
                break;
            case 'font-size':
                //TODO: re-check with Word
                //TODO: re-check with copy/pasting inside editor
                //TODO: re-check with import mindmap tool
                break;
