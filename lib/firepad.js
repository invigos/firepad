...
firepad.Firepad = (function(global) {
  ...
  Firepad.prototype.markQuickmark = function() {
    this.richTextCodeMirror_.setAttribute(ATTR.COMMENT);
    this.codeMirror_.focus();
  };
    Firepad.prototype.unmarkQuickmark = function() {
        this.richTextCodeMirror_.removeAttribute(ATTR.COMMENT);
        this.codeMirror_.focus();
    };
  ...
  Firepad.prototype.addToolbar_ = function() {
    ...
    this.toolbar.on('zoom', this.zoom, this);

    this.toolbar.on('cut', this.cut, this);
    this.toolbar.on('copy', this.copy, this);
    this.toolbar.on('paste', this.paste, this);
    this.toolbar.on('format-paragraph', this.formatParagraph, this);
