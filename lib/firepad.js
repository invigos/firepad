...
firepad.Firepad = (function (global) {
  ...
  Firepad.prototype.rangeHasAttributes = function(start, end) {
    ...
    Firepad.prototype.formatParagraph = function (size) {
        var cursor = this.codeMirror_.doc.getCursor();

        var lineLength = this.codeMirror_.doc.getLine(cursor.line).length;
        this.codeMirror_.doc.setSelection({ line: cursor.line, ch: 0 }, { line: cursor.line, ch: lineLength });

        this.richTextCodeMirror_.setAttribute(ATTR.FONT_SIZE, size);

        this.codeMirror_.doc.setCursor(cursor);
    };
    ...
    Firepad.prototype.markText = function (from, to) {
        this.codeMirror_.doc.markText(from, to, { className: 'error-marked-text' });
    ...
    Firepad.prototype.addToolbar_ = function () {
        ...
        this.toolbar.on('zoom', returnFocusDecorator.bind(this, this.zoom), this);

        this.toolbar.on('cut', returnFocusDecorator.bind(this, this.cut), this);
        this.toolbar.on('copy', returnFocusDecorator.bind(this, this.copy), this);
        this.toolbar.on('paste', returnFocusDecorator.bind(this, this.paste), this);
        this.toolbar.on('format-paragraph', returnFocusDecorator.bind(this, this.formatParagraph), this);

        this.toolbar.on('undo', returnFocusDecorator.bind(this, this.undo), this);
        this.toolbar.on('redo', returnFocusDecorator.bind(this, this.redo), this);
        this.toolbar.on('bold', returnFocusDecorator.bind(this, this.bold), this);
        this.toolbar.on('italic', returnFocusDecorator.bind(this, this.italic), this);
        this.toolbar.on('underline', returnFocusDecorator.bind(this, this.underline), this);
        this.toolbar.on('strike', returnFocusDecorator.bind(this, this.strike), this);
        this.toolbar.on('font-size', returnFocusDecorator.bind(this, this.fontSize), this);
        this.toolbar.on('font', returnFocusDecorator.bind(this, this.font), this);
        this.toolbar.on('color', returnFocusDecorator.bind(this, this.color), this);
        this.toolbar.on('left', returnFocusDecorator.bind(this, this.align, 'left'), this);
        this.toolbar.on('center', returnFocusDecorator.bind(this, this.align, 'center'), this);
        this.toolbar.on('right', returnFocusDecorator.bind(this, this.align, 'right'), this);
        this.toolbar.on('ordered-list', returnFocusDecorator.bind(this, this.orderedList), this);
        this.toolbar.on('unordered-list', returnFocusDecorator.bind(this, this.unorderedList), this);
        this.toolbar.on('todo-list', returnFocusDecorator.bind(this, this.todo), this);
        this.toolbar.on('indent-increase', returnFocusDecorator.bind(this, this.indent), this);
        this.toolbar.on('indent-decrease', returnFocusDecorator.bind(this, this.unindent), this);
        this.toolbar.on('insert-image', returnFocusDecorator.bind(this, this.makeImageDialog_), this);
