...
firepad.Formatting = (function() {
 ...
 Formatting.prototype.qmid = function(val) {
     var id = val.split("-").pop();
    return this.cloneWithNewAttribute_(ATTR.QUICKMARK_ID+'-'+id,true);
  };
   Formatting.prototype.qmclass = function() {
    return this.cloneWithNewAttribute_(ATTR.QUICKMARK,true);
  };
