...
firepad.RichTextToolbar = (function(global) {
  ...
  utils.makeEventEmitter(RichTextToolbar, ['bold', 'italic', 'langchecker', 'underline', 'strike', 'font', 'font-size', 'color',
    'left', 'center', 'right', 'unordered-list', 'ordered-list', 'todo-list', 'indent-increase', 'indent-decrease',
    'undo', 'redo', 'insert-image', 'zoom', 'cut', 'copy', 'paste', 'search', 'link', 'format-paragraph', 'import','add_quickmark', 'filter_quickmark']);
    ...
    for (var i in this.toolbarItems) {
      switch(this.toolbarItems[i]){
        ...
        case 'fontstyle': 
          ...
          break;
        case 'langchecker':
          toolbarOptions.push(utils.elt('div', [self.makeButton_('langchecker')], { 'class': 'firepad-btn-group'}));
          break;
        case 'clipboard':
        ...
        case 'import': 
          ...
          break;
          case 'add_quickmark':
              toolbarOptions.push(utils.elt('div', [self.makeButton_('add_quickmark')], { 'class': 'firepad-btn-group' }));
              break;
               case 'filter_quickmark':
              toolbarOptions.push(utils.elt('div', [self.makeButton_('filter_quickmark')], { 'class': 'firepad-btn-group' }));
              break;
      }
    };
