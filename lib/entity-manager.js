...
firepad.EntityManager = (function () {
  ...
  function EntityManager() {
    ...
    this.register('img', {
      ...
      getText: function(info) {
        // TODO: this should be correct way, but we limit it's support for now
        //return info.alt;
        return '\u00a0';
      }
    });
  ...
  EntityManager.prototype.exportToText = function(entity) {
    var elt = this.tryRenderToElement_(entity, 'getText') ||
      this.tryRenderToElement_(entity, 'render');
