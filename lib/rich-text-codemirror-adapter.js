...
firepad.RichTextCodeMirrorAdapter = (function () {
  ...
  RichTextCodeMirrorAdapter.operationFromCodeMirrorChanges = function (changes, cm) {
    ...
    //console.info('operationFromCodeMirrorChanges', changes); //console.trace();
    //console.group('operationFromCodeMirrorChanges'+rnd)
    ...
    //console.groupEnd('operationFromCodeMirrorChanges'+rnd);
