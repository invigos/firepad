...
firepad.AnnotationList = (function () {
  ...
  AnnotationList.prototype.insertAnnotatedSpan = function(span, annotation) {
    //console.log('insertAnnotatedSpan', span, annotation)
  ...
  AnnotationList.prototype.removeSpan = function(removeSpan) {
    //console.log('removeSpan', removeSpan)
  ...
  AnnotationList.prototype.getAffectedNodes_ = function(span) {
    //console.log('getAffectedNodes_', span)
  ...
  AnnotationList.prototype.mergeNodesWithSameAnnotations_ = function(list) {
    //console.log('mergeNodesWithSameAnnotations_')
    if (!list) { return; }
  ...
  AnnotationList.prototype.getAnnotatedSpansForPos = function(pos,forQM) {
    //console.info('getAnnotatedSpansForPos', pos);
    var currentPos = 0;
